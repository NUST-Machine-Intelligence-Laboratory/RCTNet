...
class Dataset(torch.utils.data.Dataset):
    ...
    def __init__(self, dataset, file_root='data/', transform=None):
        ...
        self.file_list = open(file_root + '/' + dataset + '/list/' + dataset + '.txt').read().splitlines()#SYSU/levir+
        ...
        # self.file_list = open(file_root + '/list/' + dataset + '.txt').read().splitlines()#WHU

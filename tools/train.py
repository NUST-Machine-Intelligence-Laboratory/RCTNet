...
from models.rctnet import BaseNet
...
def trainValidateSegmentation(args):
    ...
    args.savedir = args.savedir + '_' + args.file_root +str(args.text)+ '_iter_' + str(args.max_steps) + '_lr_' + str(args.lr) + '/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_root', default="SYSU", help='Data directory | LEVIR| LEVIR2| LEVIR3| LEVIR4| LEVIR5 | BCDD | SYSU| SYSU2| SYSU3| SYSU4| SYSU5 ')
